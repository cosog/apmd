...
&emsp;&emsp;通过点击界面中缝位置的图标![伸缩按钮](../images/helpdoc/PNG/025.png?t=202006161621&raw=true)或![伸缩按钮](../images/helpdoc/PNG/026.png?t=202006161621&raw=true)可实现界面伸缩。

![列表伸缩](../images/helpdoc/PNG/001.png?t=202006161621&raw=true)
...
![统计](../images/helpdoc/PNG/004.png?t=202006161621&raw=true)
...
![目标井](../images/helpdoc/PNG/005.png?t=202006161621&raw=true)

<h3><a name="2.2.3单井数据"></a>2.2.3 单井数据</h3>

&emsp;&emsp;包括图形及分析、采集、控制。

![单井数据](../images/helpdoc/PNG/006.png?t=202006161621&raw=true)
...
![光杆功图](../images/helpdoc/PNG/027.png?t=202006161621&raw=true) 
...
![泵功图](../images/helpdoc/PNG/028.png?t=202006161621&raw=true)
...
![杆柱应力](../images/helpdoc/PNG/029.png?t=202006161621&raw=true)

**（4） 泵效组成**  
&emsp;&emsp;泵的实际排量与泵的理论排量之比的百分数称为泵效。

![泵效组成](../images/helpdoc/PNG/030.png?t=202006161621&raw=true)

**（5） 物性剖面**  

![物性剖面](../images/helpdoc/PNG/031.png?t=202006161621&raw=true)

**（6） 井身轨迹**  

![井身轨迹](../images/helpdoc/PNG/032.png?t=202006161621&raw=true)
...
![电功图](../images/helpdoc/PNG/034.png?t=202006161621&raw=true) 

**（2） 电流图**  
&emsp;&emsp;电流平衡度计算：  
&emsp;&emsp;电流平衡度=下冲程电流最大值/上冲程电流最大值  

![电流图](../images/helpdoc/PNG/035.png?t=202006161621&raw=true)

**（3） 三相电流曲线**  

![三相电流曲线](../images/helpdoc/PNG/036.png?t=202006161621&raw=true)  

**（4） 目前扭矩曲线**  

![目前扭矩曲线](../images/helpdoc/PNG/037.png?t=202006161621&raw=true)

**（5） 预期扭矩曲线**  
&emsp;&emsp;根据曲柄平衡移动距离推导出的调整后的预期扭矩曲线。

![预期扭矩曲线](../images/helpdoc/PNG/038.png?t=202006161621&raw=true)

**（6） 运动特性曲线**  

![运动特性曲线](../images/helpdoc/PNG/039.png?t=202006161621&raw=true)

#### 2.2.3.2 分析

&emsp;&emsp;显示计算分析结果参数及曲线，包括产量构成、泵效、系统效率、泵出入口参数等。

![分析](../images/helpdoc/PNG/007.png?t=202006161621&raw=true)

#### 2.2.3.3 采集

&emsp;&emsp;显示传感器采集数据及曲线，包括通信状态、运行状态、油（套）压、电参数等。

![采集](../images/helpdoc/PNG/008.png?t=202006161621&raw=true)
...
![控制](../images/helpdoc/PNG/009.png?t=202006161621&raw=true)
...
![统计](../images/helpdoc/PNG/010.png?t=202006161621&raw=true)  

![目标井](../images/helpdoc/PNG/011.png?t=202006161621&raw=true)

<h2><a name="2.4生产报表"></a>2.4 生产报表</h2>  

&emsp;&emsp;各参数计算方法与全天评价模块相同。

![生产报表](../images/helpdoc/PNG/013.png?t=202006161621&raw=true)

<h2><a name="2.5图形查询"></a>2.5 图形查询</h2>

&emsp;&emsp;默认显示所有井最新地面功图，选择某一口井显示该井历史地面功图。

![图形查询](../images/helpdoc/PNG/014.png?t=202006161621&raw=true)
...
3、点击![创建按钮](../images/helpdoc/PNG/015.png?t=202006161621&raw=true)，创建模拟油田公司；填写完成后，点击![保存按钮](../images/helpdoc/PNG/016.png?t=202006161621&raw=true)，完成创建。  
...
![创建模拟油田公司](../images/helpdoc/PNG/040.png?t=202006161621&raw=true)

4、 点击![创建按钮](../images/helpdoc/PNG/015.png?t=202006161621&raw=true)，创建模拟采油厂；填写完成后，点击![保存按钮](../images/helpdoc/PNG/016.png?t=202006161621&raw=true)，完成创建。  
>- 上级单位：已创建根节点，选择模拟油田公司；  
>- 单位类别：按实际选择，厂级；
>- 单位名称：模拟采油厂。  

![创建模拟采油厂](../images/helpdoc/PNG/041.png?t=202006161621&raw=true)

5、 依次完成各级单位组织创建。

![创建模拟采油厂](../images/helpdoc/GIF/002.gif?t=202006161621&raw=true)

<h3><a name="2.6.2用户管理"></a>2.6.2 用户管理</h3>

&emsp;&emsp;接下来进入**用户管理**模块，为不同的单位组织创建用户。点击![创建按钮](../images/helpdoc/PNG/015.png?t=202006161621&raw=true)，创建新用户；填写完成后，点击![保存按钮](../images/helpdoc/PNG/016.png?t=202006161621&raw=true)，完成创建。  
...
![创建用户](../images/helpdoc/GIF/004.gif?t=202006161621&raw=true)
...
![井名信息录入](../images/helpdoc/GIF/005.gif?t=202006161621&raw=true)

#### 2.7.1.3 修改井名

&emsp;&emsp;在列表中修改井名，完成后点击![修改井名按钮](../images/helpdoc/PNG/012.png?t=202006161621&raw=true)。  
**注意：**  
**（1）不要删除修改井，再重新录入新井，会导致历史数据丢失；**  
**（2）修改完成后，点击“修改井名”按钮，不要点击“保存”按钮。**

![修改井名](../images/helpdoc/GIF/006.gif?t=202006161621&raw=true)

#### 2.7.1.4 删除数据

&emsp;&emsp;选中一行或多行，右键，选择删除行，然后点击![保存按钮](../images/helpdoc/PNG/033.png?t=202006161621&raw=true)。

![删除数据](../images/helpdoc/GIF/007.gif?t=202006161621&raw=true)
...
![生产数据录入](../images/helpdoc/GIF/008.gif?t=202006161621&raw=true)  

<h3><a name="2.7.3井身轨迹"></a>2.7.3 井身轨迹</h3>  

&emsp;&emsp;选择对应井名，将收集完成的井身轨迹数据（测量深度、井斜角、方位角）录入到“井身轨迹数据”中，点击“保存”按钮完成录入。  

![井身轨迹录入](../images/helpdoc/PNG/042.png?t=202006161621&raw=true)
...
![抽油机信息录入](../images/helpdoc/GIF/009.gif?t=202006161621&raw=true)
...
&emsp;&emsp;点击![创建按钮](../images/helpdoc/PNG/015.png?t=202006161621&raw=true)创建采控类型，如类型名称“类型八”，类型编码“type8”，类型描述“数字化抽油机数据”，创建完成后，在右侧列表中勾选实际采集项和控制项，点击![保存按钮](../images/helpdoc/PNG/033.png?t=202006161621&raw=true)完成配置。后续在**井名信息**模块数据录入时按照单井实际采控项选择不同的采集类型。

![驱动配置](../images/helpdoc/PNG/017.png?t=202006161621&raw=true)
...
![修改数据计算](../images/helpdoc/PNG/018.png?t=202006161621&raw=true)
...
![单井关联数据计算](../images/helpdoc/PNG/019.png?t=202006161621&raw=true)
...
![所有井关联数据计算](../images/helpdoc/PNG/020.png?t=202006161621&raw=true)
