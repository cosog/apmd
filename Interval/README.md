:link:[**功图软件用户手册**](../README.md):link:[**数据库文档**](.././database/):link:
...
&emsp;&emsp;《敏捷生产V7.1—电参反演软件》通过电参反演装置采集电参有功功率和电机转速周期曲线数据，结合抽油机运动参数(位置扭矩因数、平衡块位置和重量、曲柄重量、重心半径等)，进行电参转示功图；安装的设备主要包括电参采集模块、电机转速霍尔开关传感器、曲柄位置开关传感器。  
&emsp;&emsp;**优势：**  
...
![修改井名](.././Image/GIF/103.gif?raw=true)
